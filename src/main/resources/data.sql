...
-- VALUES ('Bruschetta with chicken pate and cream cheese', 390, 1, 1),
--        ('Greek salad with chickpeas and feta', 690, 1, 1),
--        ('Tom yam with coconut milk and shrimp', 850, 1, 1),
--        ('Salmon tartare', 890, 2, 2),
--        ('Spaghetti with cherry tomatoes and basil', 390, 2, 2),
--        ('Risotto with seafood', 990, 2, 2),
--        ('Борщ с говядиной, черным хлебом и салом', 530, 3, 3),
--        ('Манты с телятиной', 470, 3, 3),
--        ('Бефстроганов с картофельным пюре', 900, 3, 3);
